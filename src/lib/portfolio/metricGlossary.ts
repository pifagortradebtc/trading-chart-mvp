...
export const METRIC_TOOLTIPS: Record<string, string> = {
  ...
  calmar:
    "Calmar = годовая доходность ÷ |max-просадка|. Сколько годовых процентов вы получаете на единицу самой глубокой исторической просадки.",
  ulcer:
    "Ulcer Index = sqrt(mean(просадка²)). Учитывает и глубину, и длительность просадок; меньше — лучше.",
  beta:
    "β к BTC = насколько актив движется как BTC. β=1 — двигается синхронно, β=2 — вдвое сильнее, β=0 — независимо.",
  "β btc":
    "β к BTC = насколько актив движется как BTC. β=1 — двигается синхронно, β=2 — вдвое сильнее, β=0 — независимо.",
  "β-btc":
    "β к BTC = насколько актив движется как BTC. β=1 — двигается синхронно, β=2 — вдвое сильнее, β=0 — независимо.",
