        ...
        <div className="flex shrink-0 items-center justify-between gap-3 border-b border-sky-900/50 bg-sky-950/35 px-3 py-1.5 text-xs text-sky-100">
          ...
          <span className="flex shrink-0 items-center gap-2">
            <span className="hidden text-sky-300/90 sm:inline">
              {cleanChartUi
                ? "Стрелки — первый вход, цветные отрезки — средняя после DCA, круги — выход и PnL. При кросс-марже линию ликвидации не рисуем (упрощённая модель). Изолированная — уровни сетки, TP, опционально ликвидация."
